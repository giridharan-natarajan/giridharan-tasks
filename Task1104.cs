    ...
    class Task1104
    {
        public static void Main()
        {
            IList<Doctor> Studata = new List<Doctor>()
            {
                ...
                new Doctor(){DoctorID=4,DoctorName="John",Age=30,SpecializationID=4},
                new Doctor(){DoctorID=5,DoctorName="abdul",Age=23,SpecializationID=5},
                new Doctor(){DoctorID=6,DoctorName="santhosh",Age=21,SpecializationID=4},
                new Doctor(){DoctorID=7,DoctorName="sid",Age=20,SpecializationID=3},
            ...
            {
                new specialization(){SpecializationID=1, SpecializationName="General physician"},
                ...
                new specialization(){SpecializationID=5, SpecializationName="Gastroentology"}
            };
